@extends('layouts.app',['activePage' => 'pickup_timeslot'])

@section('title','Vendor Pickup Timeslots')

@section('content')

    <section class="section">
        <div class="section-header">
            <h1>{{ $vendor->name }}&nbsp;{{__('PickUp Time')}}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ url('vendor/home') }}">{{__('Dashboard')}}</a></div>
                <div class="breadcrumb-item">{{__('Pick-up Time Slots')}}</div>
            </div>
        </div>
        <div class="section-body">
            <h2 class="section-title">{{__("Pick-Up Time Slot Management")}}</h2>
            <p class="section-lead">{{__('Add and Edit Pick-Up Time Slots')}}</p>
            <div class="card p-5">
                <div class="row">
