...
class _EditProfileInformationState extends State<EditProfileInformation>
  ...
  void initState() {
    ...
    _controller = new TabController(length: 2, vsync: this, initialIndex: tabIndex);
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(
            ...
            style: TextStyle(
                fontWeight: FontWeight.w900, fontSize: 20.0, fontFamily: Constants.appFontBold),
          ),
          bottom: TabBar(
                                  ...
                                  GestureDetector(
                                    child: Row(
                                      children: [
                                        ...
                                        Text(Languages.of(context)!.changeProfilePicture,
                                          style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 15,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      CardTextFieldWidget(
                                        ...
                                        textInputAction: TextInputAction.next,
                                        hintText: Languages.of(context)!.iFSCCode1,
                                        textInputType: TextInputType.text,
                                      ...
                                      CardTextFieldWidget(
                                        ...
                                        textInputAction: TextInputAction.next,
                                        hintText: Languages.of(context)!.mICRCode1,
                                        textInputType: TextInputType.text,
                                        textEditingController: _micrCodeController,
                                        validator: validateMICRCode,
                                      ),
                                      AppLableWidget(
                                        title: Languages.of(context)!.bankAccountName,
                                      ),
                                      CardTextFieldWidget(
                                        focus: (v) {
                                          FocusScope.of(context).nextFocus();
                                        ...
                                        textInputAction: TextInputAction.next,
                                        hintText: Languages.of(context)!.bankAccountName1,
                                        textInputType: TextInputType.text,
                                        textEditingController: _accountNameController,
                                        validator: validateAccountname,
                                      ),
                                      AppLableWidget(
                                        title: Languages.of(context)!.bankAccountNumber,
                                      ),
                                      CardTextFieldWidget(
                                        focus: (v) {
                                          FocusScope.of(context).nextFocus();
                                        ...
                                        hintText: Languages.of(context)!.bankAccountNumber1,
                                        textInputType: TextInputType.text,
                                      ...
                                      Padding(
                                        ...
                                        child: RoundedCornerAppButton(
                                          onPressed: () {
                                            if (_formKeyForBankDetails.currentState!.validate()) {
                                              submitBankDetails();
                                            } else {
                                              setState(() {
                                                // validation error
                                          ...
                                          btnLabel: Languages.of(context)!.labelSubmit,
                                        ),
                                      ),
                                    ],
                                  ),
