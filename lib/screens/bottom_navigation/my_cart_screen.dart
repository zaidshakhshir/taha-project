                                                  ...
                                                  children: [
                                                    ...
                                                    cartMenuItem[position]
                                                      ...
                                                      onTap: () {
                                                        ...
                                                        for (int z = 0; z < model.cart.length; z++) {if (cartMenuItem[position].id == model.cart[z].id) {
                                                        ...
                                                        openFoodCustomizationBottomSheet(model, cartMenuItem[position],
                                                            double.parse(cartMenuItem[position].price.toString()),
                                                            double.parse(currentPriceWithoutCustomization!),
                                                            totalPrice,
                                                            cartMenuItem[position].custimization!,
                                  ...
                                  InkWell(
                                    onTap: () {
                                      addressSetState(() {
                                        ...
                                        Navigator.pop(context);
                                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => DashboardScreen(2),));
