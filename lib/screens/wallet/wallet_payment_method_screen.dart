...
class WalletPaymentMethodScreen extends StatefulWidget {
  ...
  const WalletPaymentMethodScreen(
      {Key? key, this.orderAmount,}) : super(key: key);
                        ...
                        children: [
                          Container(
                            child: Padding(
                              ...
                              child: listPayment.length > 0 ? ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) => Column(
                                  children: [
                                    customRadioList(listPaymentName[index], listPayment[index],
                              ...
                              onPressed: () {
                                if (orderPaymentType != null) {
                                   if (orderPaymentType == 'RAZOR') {
                                    ...
                                    stripeSecretKey = SharedPreferenceUtil.getString(
                                        Constants.appStripeSecretKey);
                                    stripePublicKey = SharedPreferenceUtil.getString(
                                  ...
                                  Constants.toastMessage(
                                      Languages.of(context)!.labelPleaseSelectPaymentMethod);
                                }
                              },
              ...
              child: ClipRRect(
                ...
                child: SizedBox(
                  ...
                  child: SvgPicture.asset(
                    radioindex == index ? 'images/ic_completed.svg' : 'images/ic_gray.svg',
                    width: 15,
